...
# Page configuration
st.set_page_config(
    page_title="Chat with Arul Jeeva Pio",
    page_icon="🤖",
    layout="centered",
...
def ask_chatbot(query, chat_history=None):
    ...
    # Build system prompt
    system_prompt = (
        f"You are Arul Jeeva Pio's personal AI assistant. "
        f"Your job is to help users learn about Arul Jeeva Pio's background, "
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about Arul Jeeva Pio. "
        ...
        f"Answer in third person when talking about Arul Jeeva Pio, but you may use natural conversational language "
